...
<p align="center">
  <img src="https://github.com/booklore-app/booklore/blob/develop/assets/demo.gif?raw=1" alt="BookLore Demo" width="800px" style="border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);" />
</p>
...
**BookLore** is a powerful, self-hosted web application designed to organize and manage your personal book collection
with elegance and ease. Build your dream library with an intuitive interface, robust metadata management, and seamless
multi-user support.
